...
const Services = () => {
  const servicesData = [
    ...
    },
    {
      ...
      description: "We help you execute your plan and delicar results",
  ...
  return (
    <motion.div
      ...
      id="services"
      className="relative flex flex-col items-center gap-7 px-4 sm:px-24 lg:px-24  xl:px-40 pt-30 text-gray-700 dark:text-white"
    >
      <img
        src={assets.bgImage2}
        alt=""
